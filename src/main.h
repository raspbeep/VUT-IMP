...
max_config max30102_configuration = {
		...
		.MODE_CONF.SHDN             = 0,
		.MODE_CONF.RESET            = 0,
		.MODE_CONF.MODE             = 0b111,  //SPO2 mode
		...
		.LED1_PULSE_AMP.LED1_PA     = 0xFF,   //CORRENTE DO LED1 25.4mA
		.LED2_PULSE_AMP.LED2_PA     = 0xFF,   //CORRENTE DO LED2 25.4mA

		.PROX_LED_PULS_AMP.PILOT_PA = 0X7F,

		.MULTI_LED_CONTROL1.SLOT2   = 0b010,      //Desabilitado
		.MULTI_LED_CONTROL1.SLOT1   = 0b001,      //Desabilitado
